...
interface Man {
  ...
  // Create Class Here
// class Player {
//     constructor(public username : string,public nickname : string,public level:number|string,public vip?:boolean ){}
//     details() : string {
//         return `${this.vip ? "VIP " : ""}${this.username}, Type Is ${this.nickname} Level Is ${this.level}`;
//     }
// }
// // Do Not Edit The Code Below
...
//   console.log(tester.username);
  ...
  console.log(tester.getter); // Property 'title' does not exist on type 'Show'
  tester.setter = "Osama"; // Property 'title' does not exist on type 'Show'
  console.log(tester.getter); // Property 'title' does not exist on type 'Show'
  interface Play {
    id: number;
    title: string;
...
//     }
//      public logOut(sentence: string): void {
//         return console.log(`Logged Out, ${sentence}`);
